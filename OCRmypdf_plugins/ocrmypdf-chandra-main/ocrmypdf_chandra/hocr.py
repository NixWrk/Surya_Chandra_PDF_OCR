"""hOCR helpers for Chandra OCR output."""
...
def build_hocr(
    *,
    ...
    """Build hOCR document from normalized Chandra line dictionaries."""
    page_width = max(1, int(page_width))
    page_height = max(1, int(page_height))
    ...
    out: list[str] = [
        ...
        '<meta name="ocr-system" content="chandra-ocr via ocrmypdf-chandra" />',
